...
async def _telegram_notify_rum(entry: dict) -> None:
    """Kirim notifikasi Telegram saat ada RUM activity baru."""
    try:
...
async def rum_activity_get(
    ...
    platform:        str = "",
    language:        str = "",
    user_timezone:   str = "",   # FIX: was "timezone" — shadowed datetime.timezone
    cores:           int = 0,
    touch_points:    int = 0,
    online:          str = "",
    timestamp:       str = "",
    ...
    asyncio.create_task(_telegram_notify_rum(entry))
